        ...
        <SafeAreaProvider>
            <SafeAreaView className={darkMode ? "flex-1 bg-[rgb(18,18,18)]" : "flex-1 bg-white"}>
                <View className={darkMode ? "flex-1 bg-[rgb(18,18,18)] items-center relative" : "flex-1 bg-white items-center relative"}>
                    ...
                    {
                        owner === 'other' && (
                            <OthersProfileComponents setSelectedPost={setSelectedPost} Following={Following} searchUserUid={searchUserUid} darkMode={darkMode} visible={visible} searchUserInfo={searchUserInfo}
