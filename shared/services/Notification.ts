...
export const FollowNotificationTrigger = async (targetUserId: string, currentUserId: string) => {
...
export const LikeNotificationTrigger = async (targetUserId: string, currentUserId: string, postId: string) => {
  await addDoc(collection(db, "notifications"), {
    toUserId: targetUserId,
    fromUserId: currentUserId,
    type: "LIKE",
